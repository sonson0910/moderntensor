...
.. deprecated::
    Use `LuxtensorValidator` for Luxtensor RPC compatibility.
"""
...
warnings.warn(
    "ValidatorInfo is deprecated. Use LuxtensorValidator for Luxtensor RPC compatibility.",
    DeprecationWarning,
    stacklevel=2
)
...
class ValidatorInfo(BaseModel):
    ...
    .. deprecated:: Use LuxtensorValidator instead.
    """
