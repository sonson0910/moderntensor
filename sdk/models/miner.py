...
.. deprecated::
    Use `LuxtensorMiner` for Luxtensor RPC compatibility.
"""
...
warnings.warn(
    "MinerInfo is deprecated. Use LuxtensorMiner for Luxtensor RPC compatibility.",
    DeprecationWarning,
    stacklevel=2
)
...
class MinerInfo(BaseModel):
    ...
    .. deprecated:: Use LuxtensorMiner instead.
    """
